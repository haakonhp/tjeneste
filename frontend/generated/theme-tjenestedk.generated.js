...
import stylesCss from 'themes/tjenestedk/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_tjenestedk_componentCss']) {
    
    document['_vaadintheme_tjenestedk_componentCss'] = true;
  }
